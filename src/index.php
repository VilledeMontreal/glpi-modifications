        ...
        <div id="login-body" class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well">
            ...
            <form role="form" action='front/login.php' method='post'>
              ...
              <div class="form-group">
                  <input class="form-control input-lg" name="<?php echo $namfield; ?>" id="login_name" required="required" placeholder="<?php echo __('User') ?>" type="text">
              </div>
              <div class="form-group">
                  <input class="form-control input-lg" name="<?php echo $pwdfield; ?>" id="login_password" required="required" placeholder="<?php echo __('Password') ?>" type="password">
              </div>
				  <?php if ($CFG_GLPI["login_remember_time"]) {
	...
	<?php
	  echo "</div>"; // end contenu login
	   ...
	   if (GLPI_DEMO_MODE) {
		...
		//echo "<div id='footer-login' class='home col-md-12 col-sm-6'>" . Html::getCopyrightMessage() . "</div>";	
	
	   echo "<div id='footer-login'>\n";
	   echo "<a href='http://glpi-project.org/' title='Powered By Teclib' style='color:#fff;'>";
	   echo "GLPI ".(isset($CFG_GLPI["version"])?$CFG_GLPI["version"]:"")." Copyright (C) 2015 - ".date('Y').	        
	        " Teclib and contributors <br />\n".
